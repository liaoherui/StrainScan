...
def main():
	...
	parser.add_argument('-m','--mafft_sample',dest='mas',type=str,help='If this parameter is 1, then the program will search joint kmer sets from msa generated by mafft. (default: 0)')
	...
	Build_kmer_sets_unique_region_lasso_test_allinone_sp.build_kmer_sets(dc95_l2,kmer_sets_l2,ksize,uknum,gkratio,mas)
